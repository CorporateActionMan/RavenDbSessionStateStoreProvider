...
namespace Tests
{
    public class ReleaseItemExclusive_when_application_does_not_match : RavenSessionStateTest
    {
        ...
        public ReleaseItemExclusive_when_application_does_not_match()
        {
            ...
            Subject.ApplicationName = "FooBar!";
