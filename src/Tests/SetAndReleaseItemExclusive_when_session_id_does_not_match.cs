...
namespace Tests
{
    ...
    public class SetAndReleaseItemExclusive_when_session_id_does_not_match : SetAndReleaseItemExclusiveTest
    {
        ...
        protected override SessionStateDocument PreExistingSessionStateDocument
        {
            get
            {
                return new SessionStateDocument("Another SessionId", ApplicationName)
                {
                    Locked = true,
                    LockId = 4,
